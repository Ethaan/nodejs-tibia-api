...
var tibiaCharacterDeathParser = exports.tibiaCharacterDeathParser = function tibiaCharacterDeathParser(characterName) {
  return function (body) {
    var $ = _cheerio2.default.load(body);
    return $('b:contains("Character Deaths")').parent().parent().parent().find('tr').map(characterDeathInformationData($, characterName)).get();
  };
};
