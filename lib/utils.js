...
exports.getGuildInformationByUrl = exports.getCharacterInformationByName = exports.getOnlinePlayersByWorld = exports.getTibiaWorlds = exports.requestUrl = undefined;
...
var getCharacterInformationByName = exports.getCharacterInformationByName = function getCharacterInformationByName(characterName) {
  return new Promise(function (resolve, reject) {
    ...
    requestUrl(characterByNameUrl, (0, _parsers.tibiaCharacterInformationParser)(characterName)).then(function (result) {
      resolve(result);
    }).catch(function (error) {
      return reject(error);
    });
